...
public class ThirdLevel extends GameLevel{
    ...
    protected void addTrains() {
        field.createTrain(new Point2D.Double(10, 20), Direction.RIGHTUP);
        field.createTrain(new Point2D.Double(30, 40), Direction.BACKWARDDOWNRIGHT);
        field.createTrain(new Point2D.Double(60, 10), Direction.UPBACKWARDLEFT);
    }
    ...
    private static List<Point2D> setUpFirstPoints() {
        ...
        Point2D first_path_6 = new Point2D.Double(60, 20);
        Point2D first_path_7 = new Point2D.Double(70, 20);
        Point2D first_path_8 = new Point2D.Double(80, 20);

        return List.of(first_path_1, first_path_2, first_path_3, first_path_4, first_path_5, first_path_6, first_path_7, first_path_8);
    }
    ...
    private static List<Point2D> setUpThirdPoints() {
        Point2D third_path_1 = new Point2D.Double(60, 10);
        Point2D third_path_2 = new Point2D.Double(60, 20);
        Point2D third_path_3 = new Point2D.Double(60, 30);
        Point2D third_path_4 = new Point2D.Double(60, 40);

        return List.of(third_path_1, third_path_2, third_path_3, third_path_4);
    }
}
