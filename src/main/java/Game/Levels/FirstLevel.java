...
public class FirstLevel extends GameLevel {
    ...
    private static List<Point2D> setUpFirstPoints() {
        Point2D first_path_1 = new Point2D.Double(10, 10);
        Point2D first_path_2 = new Point2D.Double(20, 10);
        Point2D first_path_3 = new Point2D.Double(30, 10);
        Point2D first_path_4 = new Point2D.Double(40, 10);
        Point2D first_path_5 = new Point2D.Double(50, 10);
        Point2D first_path_6 = new Point2D.Double(60, 10);
    ...
    private static List<Point2D> setUpThirdPoints() {
        Point2D second_path_1 = new Point2D.Double(40, 30);
        Point2D second_path_2 = new Point2D.Double(30, 30);
